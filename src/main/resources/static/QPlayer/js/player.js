(function($){
	...
	for (var i = 0; i < playlist.length; i++){
		var item = playlist[i];
		$('#playlist').append('<li class="lib" style="overflow:hidden;"><span style="margin-left: 5px;" class="artist">'+item.title+'</span><span style="float: right;" class="artist">'+item.artist+'</span></li>');
		if (item.mp3 == "") {
	...
	var loadMusic = function(i){
		...
		$('.musicTag').html('<span class="artist">'+item.title+'</span><span> - </span><span class="artist">'+item.artist+'</span>');
