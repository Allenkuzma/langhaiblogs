...
/**
 * 代码生成器
 * 执行方法 修改模块表名回车自动生成对应项目目录中
 *
 * @author langhai
 * @date 2023-01-27 15:09
 */
@SpringBootTest
public class CodeGenerator {
    ...
    public void CodeGenerator() {
        ...
        dsc.setDriverName(mySQLConfig.getDriverClassName());
        ...
        */
        ...
        strategy.setInclude(setModuleName);
